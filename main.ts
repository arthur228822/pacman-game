controller.up.onEvent(ControllerButtonEvent.Pressed, function () {
    pacman.x = pacman.x + jump_speed
    jump_speed = 10
    pacman.setVelocity(0, 50)
})
sprites.onCreated(SpriteKind.StatusBar, function (sprite) {
    heal_food = sprites.create(img`
        .............beebbbb............
        ............eebbbb4bb...........
        ............eb344bb4bb..........
        ............e44334bb4bb.........
        ...
        ...........bd4eb43333344bb...7..
        ..........b455d4443333444bb.....
        .....7....4d5555d444333444bb....
        ....777..4555555dd4b4443444be...
        .....7..bd5555d555d4bb444444ee..
        ...
        bd5ddd2eee3d444555dd4e....7.....
        b555115dddd55d544eede....777....
        4511d444d5544ee...4de.....7.....
        41d4555d4ee........44...........
        41554eede.......................
        44ee...4e.......................
        `, SpriteKind.Food)
    heal_food.setPosition(0, 74)
    scaling.scaleByPercent(heal_food, -60, ScaleDirection.Uniformly, ScaleAnchor.Middle)
})
let heal_food: Sprite = null
let jump_speed = 0
...
pacman.setPosition(10, 73)
pacman.setStayInScreen(true)
controller.player1.moveSprite(pacman, 50, 0)
